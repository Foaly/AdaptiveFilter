...
Die vorliegende Aufgabe dreht sich um die Systemidentifikation mit Hilfe adaptiver Filter.
...
Auf der linken Seite ist der quadratischen Fehlers (Squared-Error bzw. SE) über den zeitlichen Verlauf in Samplen dargestellt. 
...
Außerdem sei angemerkt, dass der Plot des Fehler mit einem Moving Average von 30 Samplen geglättet wurde, um einzelne Ausreißer zu entfernen und die Lesbarkeit zu erhöhen.
...
Die Algorithmen gelingt die Adaption für das IIR System also leicht schlechter als für das FIR System.
...
Die berechneten Koeffizienten beider Algorithmen konvergierten nicht auf die Vorgegebenen, sondern konvergierten auf andere Werte, um das System hinreichend genau approximiert.
...
Bei einem IIR System ist dies jedoch mit den beiden untersuchten Algorithmen nicht exakt möglich, da IIR Systeme einen rekursiven Anteil besitzen, welcher weder im LMS noch im RLS Algorithmen abgebildet werden können.
...
Der RLS ist erneut leicht robuster gegen hinzugefügtes Rauschen verglichen mit dem LMS.
