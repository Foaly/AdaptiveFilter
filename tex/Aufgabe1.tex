...
Schließlich wurde sich für $\mu = 0.5$ und $\sigma = 0.5$ entschieden, womit die Filter ein gutes Adaptionsverhalten aufwiesen.
...
Die Filtergewichtung und Filterkoeffizienten der Systeme wurden anschließend eingefroren und im darauffolgenden Testdurchlauf auf dem Testdatensatz nicht weiter angepasst.
